...
(function (factory) {
    ...
    BootstrapDualListbox.prototype = {
        ...
        setBtnMoveText: function (value, refresh) {
            ...
            this.elements.moveButton.append($('<i>').addClass('fas fa-angle-right'));//.html(value);
            if (refresh) {
                refreshSelects(this);
            }
            return this.element;
        ...
        setBtnRemoveText: function (value, refresh) {
            this.settings.btnMoveText = value;
            this.elements.removeButton.append($('<i>').addClass('fas fa-angle-left'));//.html(value);
            if (refresh) {
                refreshSelects(this);
            }
            return this.element;
        ...
        setBtnMoveAllText: function (value, refresh) {
            this.settings.btnMoveText = value;
            this.elements.moveAllButton.append($('<i>').addClass('fas fa-angle-double-right'));//.html(value);
            if (refresh) {
                refreshSelects(this);
            }
            return this.element;
        ...
        setBtnRemoveAllText: function (value, refresh) {
            this.settings.btnMoveText = value;
            this.elements.removeAllButton.append($('<i>').addClass('fas fa-angle-double-left'));//.html(value);
            if (refresh) {
                refreshSelects(this);
            }
            return this.element;
