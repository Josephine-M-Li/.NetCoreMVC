...
(function (window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        pageSize: 20,
        pageButtonCount: 15,
        pagerFormat: "Pages: {first} {prev} {pages} {next} {last} &nbsp;&nbsp; Page {pageIndex} of {pageCount} Total {itemCount} Record",
        pagePrevText: "Prev",
        pageNextText: "Next",
        pageFirstText: "First",
        pageLastText: "Last",
        ...
        _createBody: function () {
            ...
            //±Nscrollbar§ï¦¨overlayScrollbars
            try {
                $body.overlayScrollbars({
                    callbacks: {
                        onScroll: $.proxy(function (eventArgs) {
                            this._header.scrollLeft(eventArgs.target.scrollLeft);
                        }, this)
                    }
                });
            } catch (e) { }
        ...
        _createInsertRow: function () {
            ...
            this._eachField(function (field) {
                var prepare = this._prepareCell("<td>", field, "insertcss")
                    .append(this.renderTemplate(field.insertTemplate, field))

                if (field.type == 'checkbox') {
                    var _for = "";
                    try {
                        _for = prepare.children('input')[0].id;
                    } catch (e) { }
                    prepare.addClass('icheck-primary').append('<label for="' + _for + '"/>');
                }
                prepare.appendTo($result);
            });
        ...
        _createCell: function (item, field) {
            ...
            if ($.isFunction(field.cellRenderer)) {
                ...
                if (field.type == 'checkbox') {
                    $result.addClass('icheck-primary');
                    $result.append('<label />');
                }
            }
        ...
        _createEditRow: function (item) {
            ...
            this._eachField(function (field) {
                var fieldValue = this._getItemFieldValue(item, field);
                var prepare = this._prepareCell("<td id='1'>", field, "editcss")
...
(function (jsGrid, $, undefined) {
    ...
    NumberField.prototype = new TextField({
        ...
        _createTextBox: function () {
            return $("<input>").attr("type", "number").addClass("form-control")
                .prop("readonly", !!this.readOnly);
        }
    });
...
(function (jsGrid, $, undefined) {
    ...
    TextAreaField.prototype = new TextField({
        ...
        _createTextArea: function () {
            return $("<textarea>").prop("readonly", !!this.readOnly).addClass("form-control");
        }
    });
...
(function (jsGrid, $, undefined) {
    ...
    CheckboxField.prototype = new Field({
        ...
        filterTemplate: function () {
            ...
            if (this.autosearch) {
                $result.find('input').on("click", function () {
                    grid.search();
                });
            }
        ...
        _createCheckbox: function () {
            ...
            return $("<input id='" + id + "'>").attr("type", "checkbox");
        }
    });
